    ...
    <footer className="bg-[#2A1506] border-t border-[#D4AF37]/10">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="flex flex-col mb-4">
              ...
              <span className="text-[10px] tracking-[0.3em] text-[#8B6B47]">CLUB &amp; RESORT</span>
            </Link>
            <p className="text-[#8B6B47] text-sm leading-relaxed mb-4 max-w-md">
            ...
            <div className="mt-3 space-y-1">
              <p className="text-[#8B6B47] text-xs font-semibold tracking-wide mb-1">Explore More Properties</p>
              ...
              <p className="text-[#8B6B47] text-[10px] mt-2">
                Also accessible at:{" "}
          ...
          <div>
            ...
            <ul className="space-y-2">
              {["Home", "Properties", "Masterplan", "Gallery", "About", "Contact", "FAQ", "Blog"].map((link) => (
                <li key={link}>
                  <Link href={link === "Home" ? "/" : `/${link.toLowerCase().replace(" ", "-")}`} className="text-[#8B6B47] text-sm hover:text-[#D4AF37] transition-colors">
                    {link}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-2">
              {projects.filter((p) => p.status !== "Launching Soon").map((p) => (
                <li key={p.id}>
                  <Link href={`/projects/${p.slug}`} className="text-[#8B6B47] text-sm hover:text-[#D4AF37] transition-colors">
                    {p.name}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href={`tel:${PHONE_NUMBER}`} className="flex items-center gap-2 text-[#8B6B47] text-sm hover:text-[#D4AF37] transition-colors">
                  <Phone className="w-4 h-4" /> {PHONE_NUMBER}
                </a>
              </li>
              <li>
                <a href={`mailto:${EMAIL}`} className="flex items-center gap-2 text-[#8B6B47] text-sm hover:text-[#D4AF37] transition-colors">
              ...
              <li className="flex items-start gap-2 text-[#8B6B47] text-sm">
            ...
            <div className="mt-4 pt-4 border-t border-[#D4AF37]/10">
              <h5 className="text-[#8B6B47] text-xs tracking-wide mb-2">Trusted Resources</h5>
              {[
                ...
                <a key={r.url} href={r.url} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1 text-[#8B6B47] text-xs hover:text-[#D4AF37] transition-colors mb-1">
        ...
        <div className="mt-12 pt-6 border-t border-[#D4AF37]/10 text-center">
          <p className="text-[#8B6B47] text-xs">
