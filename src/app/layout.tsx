...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  const pixelId = process.env.NEXT_PUBLIC_META_PIXEL_ID || "2285714688927507";
  const gaId = "G-V0RV1BE85R"; // Grand Polo GA4
  const pixelIdValid = true; // Always render — hardcoded fallback above
...
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
})(window,document,'script','dataLayer','GTM-KNS9ZKZK');`,
          }}
        />
      ...
      <body className="min-h-full flex flex-col bg-[#5D3A1A] text-[#FFFAF3]">
        ...
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-KNS9ZKZK"
            height="0"
            width="0"
