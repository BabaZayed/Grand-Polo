  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-[#5D3A1A]">
      <div className="text-center px-4 max-w-lg">
        ...
        <p className="text-[#8B6B47] text-base mb-8 leading-relaxed">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <Link href="/contact">
            <Button variant="outline" className="border-[#8B6B47]/50 text-[#8B6B47] hover:bg-[#8B6B47]/10 px-8 py-3 rounded-md">
