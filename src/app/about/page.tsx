      ...
      <main className="pt-16 lg:pt-20">
        ...
        <section className="py-16 lg:py-20 bg-[#0C1220]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            ...
            <p className="text-[#8B8678] leading-relaxed mb-4">
            ...
            <p className="text-[#8B8678] leading-relaxed">
        ...
        <section className="py-16 lg:py-20 bg-[#070B14]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            ...
            <p className="text-[#8B8678] leading-relaxed mb-6">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 text-[#C9A84C] hover:text-[#E0C878] transition-colors text-sm font-medium"
            >
        ...
        <section className="py-16 lg:py-20 bg-[#0C1220]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="glass-card rounded-xl p-8 max-w-xl mx-auto">
              <h3 className="font-heading text-xl font-bold text-[#FAF6F0] mb-3">
                Explore The Oasis
              </h3>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 text-[#C9A84C] hover:text-[#E0C878] transition-colors font-medium"
              >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="glass-card rounded-xl p-5 hover:border-[#C9A84C]/30 transition-all group block"
                >
                  <h3 className="text-[#FAF6F0] font-medium group-hover:text-[#C9A84C] transition-colors flex items-center gap-2">
                    {item.name} <ExternalLink className="w-3 h-3" />
                  </h3>
                  <p className="text-[#8B8678] text-sm mt-1">{item.desc}</p>
                </a>
              ))}
            </div>
          </div>
