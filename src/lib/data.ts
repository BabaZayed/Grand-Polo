...
export const PHONE_NUMBER = "+971 4 123 4567";
export const WHATSAPP_LINK = "https://wa.me/97141234567";
...
export const projects: Project[] = [
  ...
  ...["selvara-1", "selvara-2", "selvara-3", "selvara-4"].map((id, i) => ({
    id,
    name: id.replace("-", " ").replace(/\b\w/g, (c) => c.toUpperCase()),
    slug: id,
    type: "villa" as PropertyType,
    tagline: "Selvara Living — Coming Soon",
    description: `Selvara ${i + 1} at Grand Polo Club & Resort represents the next evolution of equestrian luxury. These exclusive residences will offer unparalleled access to polo fields, stables, and the luxury clubhouse within Dubai's most prestigious equestrian community. Register your interest for priority selection at launch.`,
    bedrooms: "TBA",
    startingPrice: 0,
    areaRange: "TBA",
...
export const galleryImages: GalleryImage[] = [
  { id: "g1", category: "Equestrian", alt: "Grand Polo Club aerial view", imageUrl: "/images/gallery/polo-club.jpg" },
  { id: "g2", category: "Equestrian", alt: "Dubai Polo and Equestrian Club", imageUrl: "/images/gallery/dubai-polo.jpg" },
  { id: "g3", category: "Equestrian", alt: "The Stables at Grand Polo", imageUrl: "/images/gallery/stables-1.jpg" },
  { id: "g4", category: "Equestrian", alt: "Stables interior courtyard", imageUrl: "/images/gallery/stables-2.jpg" },
  { id: "g5", category: "Equestrian", alt: "Polo Fields panoramic view", imageUrl: "/images/gallery/polo-field-1.jpg" },
  { id: "g6", category: "Clubhouse", alt: "The Clubhouse at Grand Polo", imageUrl: "/images/gallery/clubhouse-1.jpg" },
  { id: "g7", category: "Exterior", alt: "Chevalia Estate 2 luxury villa", imageUrl: "/images/gallery/ce2-render-1.jpg" },
  { id: "g8", category: "Exterior", alt: "Chevalia Estate 2 facade", imageUrl: "/images/gallery/ce2-render-2.jpg" },
  { id: "g9", category: "Exterior", alt: "Chevalia Estate 2 evening render", imageUrl: "/images/gallery/ce2-render-3.jpg" },
  { id: "g10", category: "Exterior", alt: "Chevalia Estate 2 garden view", imageUrl: "/images/gallery/ce2-render-4.jpg" },
  { id: "g11", category: "Exterior", alt: "Chevalia Estate 2 pool area", imageUrl: "/images/gallery/ce2-render-5.jpg" },
  { id: "g12", category: "Exterior", alt: "Chevalia Estate villa exterior", imageUrl: "/images/gallery/ce1-render-1.jpg" },
  { id: "g13", category: "Exterior", alt: "Chevalia Estate facade detail", imageUrl: "/images/gallery/ce1-render-2.jpg" },
  { id: "g14", category: "Exterior", alt: "Chevalia Estate garden", imageUrl: "/images/gallery/ce1-render-3.jpg" },
  { id: "g15", category: "Exterior", alt: "Chevalia Fields villa render", imageUrl: "/images/gallery/cf-render-1.jpg" },
  { id: "g16", category: "Exterior", alt: "Chevalia Fields facade", imageUrl: "/images/gallery/cf-render-2.jpg" },
  { id: "g17", category: "Equestrian", alt: "Polo villa lifestyle", imageUrl: "/images/gallery/polo-villa.jpg" },
  { id: "g18", category: "Equestrian", alt: "Polo field evening", imageUrl: "/images/gallery/polo-field-2.jpg" },
];
