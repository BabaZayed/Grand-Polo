...
export const projects: Project[] = [
  ...
  },
  {
    ...
    slug: "equestra",
    type: "villa",
    tagline: "Equestrian Elegance — Luxury Villas",
    description: "Equestra at Grand Polo Club & Resort is an exquisite collection of luxury residences inspired by the grace and power of equestrian sport. Positioned within the prestigious masterplan, Equestra offers residents unparalleled access to polo fields, stables, and the exclusive clubhouse. These villas combine contemporary design with the timeless elegance of equestrian tradition, creating homes that are both sophisticated and welcoming. Each residence has been thoughtfully planned to maximise views of the Green Core while providing the privacy and comfort expected of a world-class equestrian community.",
    bedrooms: "TBA",
    startingPrice: 0,
    areaRange: "TBA",
    status: "Off-Plan",
  ...
  },
  {
    ...
    slug: "equitera",
    type: "villa",
    tagline: "The Spirit of the Horse — Luxury Villas",
  ...
  },
  {
    ...
    slug: "equitera-2",
    type: "villa",
    tagline: "Legacy Continues — Luxury Villas",
  ...
  },
  {
    ...
    slug: "montura",
    type: "villa",
    tagline: "Saddle & Style — Luxury Villas",
    description: "Montura at Grand Polo Club & Resort draws its name from the Spanish word for saddle, reflecting the equestrian heritage at the heart of this community. These luxury villas offer refined living with direct connections to the polo lifestyle. The architecture pays homage to classical equestrian estates while embracing modern design principles, resulting in homes that feel both rooted in tradition and refreshingly contemporary. Residents enjoy dedicated pathways to the polo fields and stables, making the equestrian lifestyle an integral part of daily life.",
    bedrooms: "TBA",
    startingPrice: 0,
    areaRange: "TBA",
    status: "Off-Plan",
  ...
  },
  {
    ...
    slug: "montura-2",
    type: "villa",
    tagline: "The Next Chapter — Luxury Villas",
  ...
  },
  {
    ...
    slug: "montura-3",
    type: "villa",
    tagline: "Ride the Horizon — Luxury Villas",
  ...
  },
  {
    ...
    slug: "selvara-1",
    type: "villa",
    tagline: "Selvara Living — Premium Villas",
  ...
  },
  {
    ...
    slug: "selvara-2",
    type: "villa",
    tagline: "Selvara Elegance — Exclusive Residences",
  ...
  },
  {
    ...
    slug: "selvara-3",
    type: "villa",
    tagline: "Selvara Prestige — Luxury Cluster",
  ...
  },
  {
    ...
    slug: "selvara-4",
    type: "villa",
    tagline: "Selvara Grandeur — Signature Villas",
